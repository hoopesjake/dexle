...
function drawChallenge() {
  ...
  $("chgrid").innerHTML=`<button class="chcard daily-champion-card ${done?"complete":""}" data-daily="1"><small>Once per day</small><b>Daily Champion Battle</b><span>One rotating Champion · 6 vs 6</span><em class="daily-champion-reset">${done?"Completed · ":""}resets in ${reset}</em><strong>${done?"Share Your Results":"Play Today's Battle"}</strong></button><button class="chcard regular-champion-card" data-regular="1"><small>Unlimited play</small><b>Region Champion</b><span>Choose one of nine full region circuits. Beat a region and earn a badge!</span><strong>Choose a Region</strong></button>`;
